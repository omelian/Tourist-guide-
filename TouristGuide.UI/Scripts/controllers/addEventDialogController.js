app.controller('AddEventDialogController', ['$scope', '$mdDialog', '$mdMedia', '$routeParams', '$rootScope','EventService',
     
function ($scope, $mdDialog, $mdMedia, $routeParams ,$rootScope,EventService) {
        $scope.profileId = $routeParams.profileId;
        $scope.name = null;
        $scope.description = null;
        $scope.price = null;
        $scope.duration = null;
        $scope.numberOfParticipant = null;
        $scope.photoUrl = null;
        ...
        $scope.hourOfEvent = null;
        $scope.minuteOfEvent = null;
        ...
        $scope.sendEvent = function () {
            ...
            EventService.AddEvent($scope.profileId, $scope.name, $scope.description, time, $scope.price, $scope.duration, $scope.numberOfParticipant, $scope.photoUrl).then(function (response) {
                $scope.cancel();
            })
        }

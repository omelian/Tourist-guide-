app.controller('EditReservationController', ['$scope','$window', 'ReservationService', '$mdDialog', 'reservation',
    function ($scope,$window, ReservationService, $mdDialog, reservation) {
 ...
 $scope.dayOfReservation = reservData.getDate();
 $scope.hourOfReservation = reservData.getHours();
 $scope.minuteOfReservation = reservData.getMinutes();
    $scope.numOfPersons = reservation.NumberOfPersons;
    ...
    $window.onload = function () {
        $scope.loadDateOfReservation();
        $scope.loadHourOfReservation();
        $scope.loadMinuteOfReservation();
    };
    $window.onload();
    $scope.numberStatus = '';
    $scope.timeStatus = '';
    ...
    $scope.sendReservation = function () {
        ...
        ReservationService.UpdateReservation(NumberOfPersons, time, reservation.ReservationId).then(function (response) {
            $scope.status = "ok";
            $scope.cancel();
        })

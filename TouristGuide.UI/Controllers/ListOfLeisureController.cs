...
{
    public class ListOfLeisureController : Controller
    {
        /// <summary>
        ...
        /// <see cref="ListOfLeisureController(IGuestBL guest,IUserBL user)"/>
        public ListOfLeisureController(IUnitOfWork unitOfWork)
        {
            this.unitOfWork = unitOfWork;
        }

        /// <summary>
        /// Gets Leisure places from data Base
        /// </summary>
        /// <returns>JSON Result All Profiles</returns>
        public JsonResult GetAllLeisure()
        {
            IEnumerable<ProfileListViewModel> leisureList = null;
            if (User.IsInRole(UserRoleEnum.Admin.ToString()))
            {
                leisureList = this.unitOfWork.GuestBL.GetAllLeisure()
            ...
            return this.Json(leisureList, JsonRequestBehavior.AllowGet);
        }
